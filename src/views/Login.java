...
//        Centralizando a tela
    ...
    private void setUsuarioValido() {
        this.usuarioValido = new UsuariosController().validarLogin(
                    campoUsuario.getText());
    }
    
    private void setSenhaValida() {
        this.senhaValida = new UsuariosController().getValidadeSenha(
                    campoSenha.getText(), campoUsuario.getText());
    }
    
    private void verificarUsuario(){
        if (campoUsuario.getText().equals("")) {
            Aviso1.setText(" Campo Obrigatório");
        }
        else{
            ...
            if(this.usuarioValido){
                ...
                Aviso1.setText(" Usuário Inválido");
            }
        }
    }
    ...
    private void verificarSenha(){
        if (campoSenha.getText().equals("")) {
            Aviso2.setText(" Campo Obrigatório");
        }
        else{
    ...
    private void logar() {
        if(campoUsuario.getText().equals("") || campoSenha.getText().equals("")) {
            ...
            if(senhaValida){
                new UsuariosController().setUsuarioAtual(campoUsuario.getText());
    ...
    private void initComponents() {
        ...
        campoSenha.setMinimumSize(new java.awt.Dimension(10, 26));
        ...
        Aviso1.setFont(new java.awt.Font("Cantarell", 0, 12)); // NOI18N
        Aviso1.setForeground(java.awt.Color.red);

        Aviso2.setFont(new java.awt.Font("Cantarell", 0, 12)); // NOI18N
        Aviso2.setForeground(java.awt.Color.red);
                ...
                .addGroup(painelInternoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(painelInternoLayout.createSequentialGroup()
                        ...
                        .addGroup(painelInternoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Aviso1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(campoUsuario)
                            .addComponent(campoSenha, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(Aviso2, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        painelInternoLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, painelInternoLayout.createSequentialGroup()
                ...
                .addComponent(Aviso1, javax.swing.GroupLayout.DEFAULT_SIZE, 19, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addGroup(painelInternoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
