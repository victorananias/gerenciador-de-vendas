...
public class VendasHistoricoProdutos extends javax.swing.JFrame {
    ...
    DefaultTableModel modeloTabelaHistorico = new DefaultTableModel(new Object[][] {},
            new String[] { "Código Venda", "Código Produto", "Nome Produto", "Valor", "Qnt Produto" }) {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup().addGap(408, 408, 408).addComponent(jLabel1)))
        ...
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup().addContainerGap(44, Short.MAX_VALUE)
                        .addComponent(jLabel1).addGap(33, 33, 33)
    ...
    private void buscarProdsVenda() {
        try {
            ...
            for (int i = 0; i < this.itensVenda.size(); i++) {
                this.modeloTabelaHistorico.addRow(new String[]{
        ...
        jTbProds.setModel(this.modeloTabelaHistorico);
    }
    /**
